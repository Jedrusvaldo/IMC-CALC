...
l_resultado_texto = Label(frame_baixo, text='', width=37, height=1, padx=0, pady=10, relief='flat' , anchor='center', font=('Ivy 10 bold'), bg=co0, fg=co1)
l_resultado_texto.place(x=0, y=95)

b_calcular = Button(frame_baixo, command=calcular, text='Calcular', width=34, height=1, overrelief=SOLID, relief='raise' , anchor='center', font=('Ivy 10 bold'), bg=co2, fg=co0)
